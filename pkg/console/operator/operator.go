...
func NewConsoleOperator(coi consoleinformers.ConsoleInformer, si v1.SecretInformer, operatorClient v1alpha1.ConsoleInterface, secretsClient coreclientv1.SecretsGetter) *ConsoleOperator {
	c := &ConsoleOperator{
	...
	internalController, queue := controller.New("Console", c.sync, operatorInformer.HasSynced, secretsInformer.HasSynced)
